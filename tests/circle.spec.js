...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    assert.strictEqual(
      parseFloat(radius3Circle.area.toPrecision(15)),
      3.14 * (3 ** 2));
    // Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3.
    assert.deepStrictEqual(
      {
        radius: radius3Circle.radius,
        area: parseFloat(radius3Circle.area.toPrecision(15)),
        circumference: parseFloat(radius3Circle.circumference.toPrecision(15)),
      },
      {
        radius: 3,
        area: 3.14 * (3 ** 2),
